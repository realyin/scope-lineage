...
事件 · [催收](../index.md) · 本页 100% 草拟、已确认的条目标 ✓

## 一页纸概览

**是什么**：The shop forgives part of what an overdue loan owes.

**参与者**：loan → 借据；borrower → 借款人

**发生时间**：豁免时间

**记录在**：

- `demo_dwd.dwd_collection_fee_waiver_di`（Kept as JSON on purpose: any …）
