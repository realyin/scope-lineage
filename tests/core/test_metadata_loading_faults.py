...
rejected usable metadata, and the failure aborted the whole load: two files out of 3434
...
def test_an_unusable_file_costs_only_its_own_table(tmp_path: Path) -> None:
    ...
    This is the failure that made a 3434-file directory unusable because two files in it
    were malformed.
    """
