...
16. [AI agent skill](agent-skill.md): let Claude Code, Codex, and other AI coding agents use lineage parsing, field transformation chains, and mapping documents directly.
